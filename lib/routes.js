...
var lumberjackEndpoint = require('./endpoints/lumberjackEndpoint.js');
...
function routes(app) {
  ...
  app
    ...
    .del('/core/session', SessionEndpoint.end())
    .post('/core/session/refresh', SessionEndpoint.refresh())
    .put('/core/log' , lumberjackEndpoint.create())
    .get('/core/log' , lumberjackEndpoint.exists());
